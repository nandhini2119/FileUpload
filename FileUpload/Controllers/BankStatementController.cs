...
namespace FileUpload.Controllers
{
    ...
    public class BankStatementController : ControllerBase
    {
        ...
        private void SaveToDB(FileRecord record)
        {
            ...
            bankStatement.FilePath = record.FilePath;
            bankStatement.FileName = record.FileName;
            bankStatement.FileExtension = record.FileFormat;
            bankStatement.MimeType = record.ContentType;

            dbContext.BankStatement.Add(bankStatement);
        ...
        public List<FileRecord> GetAllFiles()
        {
            ...
            return dbContext.BankStatement.Select(n => new FileRecord
            {
                Id = n.Id,
        ...
        public async Task<IActionResult> DownloadFile(int id)
        {
            ...
            var file = dbContext.BankStatement.Where(n => n.Id == id).FirstOrDefault();
